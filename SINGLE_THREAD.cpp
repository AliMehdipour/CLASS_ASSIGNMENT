...
//SINGLE-THREAD IMPLEMENTATION OF FFT8
...
int main()
{
	...
	std::complex<double> in0(100, 0), in1(170, 0), in2(200, 0), in3(170, 0), in4(100, 0), in5(29, 0), in6(0, 0), in7(29, 0);
	...
	std::cout << "Processing Time SINGLE THREAD : " << processed_time << " (microsecond)\n";
	std::cout << q5.get_fifo() << std::endl;
	std::cout << q5.get_fifo() << std::endl;
	std::cout << q5.get_fifo() << std::endl;
	std::cout << q5.get_fifo() << std::endl;
	std::cout << q5.get_fifo() << std::endl;
